...
*/
  ...
  if (isset($head_content) && $head_content && isset($subheading_content) && $subheading_content && isset($head_btn_content) && $head_btn_content) {
    ?>
    <section class="head_bg text-light py-5 px-5">
    ...
    <div class="container py-5 px-4">
       <div class="row">
          <div class=" col-md-8 col-sm-12 col-12 col-lg-8 m-auto text-center text-light py-4">
            <h1 class="text-uppercase py-2"><?php echo $secone_head_content;?> 
            </h1>
            <p class="px-3"><?php echo $secone_sub_head_content;?></p>
          </div>
        </div>
       <div class="row pt-4">
          <div class=" col-lg-4 col-md-4 col-sm-12 my-2">
            <div class="card">
              <div class="text-center"><img src="img/ms.jpg" class="img-fluid" >
              </div>
              <div class="card-body text-center text-light bg-dark">
                <h2 class="text-uppercase py-2"><?php echo $imageone_content; ?></h2>
                <p class="card-text pb-3"><?php echo $imageone_subhead_content; ?></p>
              </div>
            </div>
         </div>
         <div class=" col-lg-4 col-md-4 col-sm-12 my-2">
            <div class="card">
              ...
              <div class="card-body text-center text-light bg-dark">
                <h2 class="text-uppercase py-2"><?php echo $imagetwo_content; ?></h2>
                <p class="card-text pb-3"><?php echo  $imagetwo_subhead_content; ?></p>
              </div>
            </div>
         </div>
         <div class=" col-lg-4 col-md-4 col-sm-12 my-2">
            <div class="card">
              ...
              <div class="card-body text-center text-light bg-dark">
                <h2 class="text-uppercase py-2"><?php echo $imagethree_content; ?></h2>
                <p class="card-text pb-3"><?php echo $imagethree_subhead_content; ?></p>
              </div>
            </div>
         </div>
      </div> 
    ...
    <div class="container py-5 px-4">
       <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-12 m-auto text-center py-4">
            <h1 class="text-uppercase"><?php echo $grayhead_content; ?></h1>
             <p class="px-3"><?php echo $graysubhead_content; ?></p>
          </div>
        </div>
        <div class="row">
        <div class=" col-lg-4 col-md-4 col-sm-12 my-2 ">
          <div class="card bg-card text-light pt-5 pb-3">
            <div class="text-center"> <img src="img/logo.png" class="img-fluid"></div>
            <div class="card-body text-center">
              <h2 class="text-uppercase py-3"><?php echo $grayimageone_content; ?></h2>
              <p class="card-text pb-3"><?php echo $grayimageonesub_content; ?></p>
              <button class="btn btn-dark btn-lg btn-block"><?php echo $grayimageonebtn_content; ?></button>
            </div>
          </div>
        </div>
        ...
        <div class=" col-lg-4 col-md-4 col-sm-12 my-2 ">
          <div class="card bg-card text-light pt-5 pb-3">
            <div class="text-center"> <img src="img/logo.png" class="img-fluid"></div>
            <div class="card-body text-center">
              <h2 class="text-uppercase py-3"><?php echo $grayimagetwo_content; ?></h2>
              <p class="card-text pb-3"><?php echo $grayimagetwosub_content; ?></p>
              <button class="btn btn-dark btn-lg btn-block"><?php echo $grayimagetwobtn_content; ?></button>
            </div>
          </div>
        </div>
        ...
        <div class=" col-lg-4 col-md-4 col-sm-12 my-2 ">
          <div class="card bg-card text-light pt-5 pb-3">
            <div class="text-center"> <img src="img/logo.png" class="img-fluid"></div>
            <div class="card-body text-center">
              <h2 class="text-uppercase py-3"><?php echo $grayimagethree_content; ?></h2>
              <p class="card-text pb-3"><?php echo $grayimagethreesub_content; ?></p>
              <button class="btn btn-dark btn-lg btn-block"><?php echo $grayimagethreebtn_content; ?></button>
            </div>
          </div>
        </div>
      </div>
...
$best_btn_content = sanitize_text_field( trim( get_post_meta($post->ID, "best_btn2", true ) ) );
    ...
    if(isset($besthead_content) && $besthead_content && isset($bestsubhead_content) && $bestsubhead_content && isset($bestbtn_content) && $bestbtn_content && isset($best_head_content) && $best_head_content && isset($best_subhead_content) && $best_subhead_content && isset($best_btn_content) && $best_btn_content ){
      ?>

  <section class=" col-lg-12  col-md-12 col-12 text-light">
    <div class="row">
      <div class=" col-lg-6 col-md-6 col-sm-6 sec_ped">
        <img src="img/ms.jpg" class="img-fluid" >
      </div>
        <div class=" col-lg-6 col-md-6 col-sm-6 sec_three sec_ped">
          <div class="py-5 pl-5 pr-4">  
            <h1 class="text-uppercase pt-5 pb-2"><?php echo $besthead_content; ?></h1>
            <p class="pb-3"><?php echo $bestsubhead_content; ?></p>
            <button class="btn btn-dark text-uppercase py-2 px-5"><?php echo $bestbtn_content;?></button>
          </div>
        </div>
      </div>
    <div class="row">
      <div class=" col-lg-6 col-md-6 col-sm-6 sec_three sec_ped">
        <div class="py-5 pl-5 pr-4">  
        <h1 class="text-uppercase pt-5 pb-2"><?php echo $best_head_content;?></h1>
        <p class="pb-3"><?php echo  $best_subhead_content;?> </p>
        <button class="btn btn-dark text-uppercase py-2 px-5"><?php echo $best_btn_content;?></button>
        </div>
        </div>
        <div class=" col-lg-6 col-md-6 col-sm-6 sec_ped">
        <img src="img/ms.jpg" class="img-fluid" >
        ...
        <div class="container py-5 px-4">
          <div class="row">
            <div class="col-lg-8 m-auto text-center text-light py-4">
              <h1 class="text-uppercase py-3"><?php echo $gray_head_content;?></h1>
              <p class="px-3"><?php echo $gray_subhead_content;?></p>
            </div>
          </div>
          <div class="row py-5">
            <div class="col-lg-4 mx-auto my-4 text-center">
              <h1><?php echo $gray_subhead1;?></h1>
              <h2><?php echo $gray_subpara1;?></h2> 
            </div>
            <div class="col-lg-4 mx-auto my-3 text-center">
              <h1><?php echo $gray_subhead2;?></h1>
              <h2><?php echo $gray_subpara2;?></h2> 
            </div>
          <div class="col-lg-4 mx-auto  my-3 text-center">
            <h1><?php echo $gray_subhead3;?></h1>
            <h2><?php echo $gray_subpara3;?></h2> 
          </div>
      </div>
    </div>
  </section>
...
// section five start
  ...
  if(isset($herbeat_para_content) && $herbeat_para_content && isset($herbeat_head_content) && $herbeat_head_content){?>

  <section class="sec_four text-light py-5">
    <div class="container py-5">
      <div class="row py-5">
        <div class="col-lg-8 mx-auto text-center">
          <p><?php echo $herbeat_para_content; ?></p>
          <h1 class="text-uppercase"><?php echo $herbeat_head_content; ?></h1> 
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="sec_one text-light">
    <div class="container py-5">
      <div class="row pb-3">
        ...
        <h1 class="text-uppercase py-1"><?php echo $subscribe_head_content; ?></h1>
        <p class="py-2 px-3"><?php echo $subscribe_para_content;?> </p>
        <input type="text" placeholder="Your Email" class="pl-3">
        <button class="btn2 bg-dark text-light"><?php echo $subscribe_btn; ?></button>
        </div>
      </div>
    </div>
  </section>
